...
public class AppJdbc {
    ...
    public static void encontrarPrograma(ApplicationContext ctx) {
        ProgramaDAO pdao = (ProgramaDAO) ctx.getBean("programaDAO");
        
        Programa programa = pdao.encontrar(Long.valueOf(2));
        System.out.println("encontrarPrograma: " + programa.getNombre());

    }
    
    public static void eliminarPrograma(ApplicationContext ctx) {
        ProgramaDAO pdao = (ProgramaDAO) ctx.getBean("programaDAO");
